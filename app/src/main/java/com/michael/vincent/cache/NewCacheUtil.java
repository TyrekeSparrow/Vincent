...
public class NewCacheUtil {
    ...
    public static byte[] getByteArray(String url, int contentLength, InputStream inputStream, CacheTask.OnProgressListener onProgressListener) {
        if (inputStream != null) {
    ...
    private static void notifyProgress(CacheTask.OnProgressListener onProgressListener, String url, int contentLength, int progress) {
