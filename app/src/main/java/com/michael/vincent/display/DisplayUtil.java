...
public class DisplayUtil {
    ...
    public static void display(ImageView imageView, String url, NewDisplayOptions displayOptions, CacheTask.OnCompleteListener onCompleteListener, CacheTask.OnProgressListener onProgressListener, long delay) {
        if (imageView != null && url != null) {
    ...
    public static void cache(String url, CacheOption cacheOption, CacheTask.OnCompleteListener onCompleteListener, CacheTask.OnProgressListener onProgressListener, long delay) {
        if (url != null) {
