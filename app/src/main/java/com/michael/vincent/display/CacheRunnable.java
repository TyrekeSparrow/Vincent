...
public class CacheRunnable implements Runnable {
    ...
    private void cache() throws InterruptedException {
        ...
        final CacheTask.OnProgressListener onProgressListener = mTask.getOnProgressListener();
        // cache config
    ...
    private void postNotifyCacheComplete(final byte[] byteArray) {
        final CacheTask.OnCompleteListener onCompleteListener = mTask.getOnCompleteListener();
