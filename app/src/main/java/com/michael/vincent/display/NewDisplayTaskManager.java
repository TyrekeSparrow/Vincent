...
import com.michael.vincent.cache.ByteArrayMemoryCache;
import com.michael.vincent.util.MemoryUtil;
...
public class NewDisplayTaskManager implements ICacheTaskManager, IDisplayTaskManager {
    ...
    @Override
    public synchronized void display(ImageView imageView, String url, NewDisplayOptions displayOptions, CacheTask.OnCompleteListener onCompleteListener, CacheTask.OnProgressListener onProgressListener, long delay) {
    ...
    @Override
    public synchronized void cache(String url, CacheOption cacheOption, CacheTask.OnCompleteListener onCompleteListener, CacheTask.OnProgressListener onProgressListener, long delay) {
        // check memory
