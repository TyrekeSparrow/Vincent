...
public class ReuseIconManager {
        ...
        if (inBitmap != null) {
            if (!isInBitmapReused(inBitmap)) {
                ...
                if (REUSE_BITMAPS.containsKey(inBitmap)) {
                    LLog.i(Tags.ICON_VISIBILITY, "!!!!!!!!!!!!!!!! recycle impl remove inBitmap = " + System.identityHashCode(inBitmap));
                    REUSE_BITMAPS.remove(inBitmap);
                }
                // recycle bitmap
                if (!inBitmap.isRecycled()) {
                    LLog.i(Tags.ICON_VISIBILITY, "!!!!!!!!!!!!!!!! recycle impl recycle inBitmap = " + System.identityHashCode(inBitmap));
                    inBitmap.recycle();
                }
                dumpInBitmaps();
            }
    ...
    */
    ...
    public static Bitmap getInBitmap(ImageView imageView) {
        ...
        if (inBitmap == null) {
            inBitmap = BitmapUtil.generateIconInBitmap();
//            LLog.i(Tags.ICON_VISIBILITY, "@@@@@ generate empty inBitmap " + System.identityHashCode(inBitmap));
        }
        if (inBitmap != null) {
            REUSE_BITMAPS.put(inBitmap, imageView);
            dumpInBitmaps();
        }
//        LLog.i(Tags.ICON_VISIBILITY, "----- getInBitmap " + System.identityHashCode(inBitmap));
        return inBitmap;
    }
...
//                    LLog.i(Tags.ICON_VISIBILITY, "----- releaseInBitmap " + System.identityHashCode(bitmap) + " related imageView = " + System.identityHashCode(entry.getValue()));
...
//        LLog.i(Tags.ICON_VISIBILITY, "-------------------------- releaseAllBitmaps size = " + REUSE_BITMAPS.size());
        for (Entry<Bitmap, ImageView> entry : REUSE_BITMAPS.entrySet()) {
            final Bitmap inBitmap = entry.getKey();
            if (inBitmap != null) {
                releaseInBitmap(inBitmap);
...
//        LLog.i(Tags.ICON_VISIBILITY, "===============================================================");
//        LLog.i(Tags.ICON_VISIBILITY, "REUSE_BITMAPS size = " + REUSE_BITMAPS.size());
        for (Entry<Bitmap, ImageView> entry : REUSE_BITMAPS.entrySet()) {
//            LLog.i(Tags.ICON_VISIBILITY, "reuseBitmap = " + System.identityHashCode(entry.getKey()) + " related imageView = " + System.identityHashCode(entry.getValue()));
        }
//        LLog.i(Tags.ICON_VISIBILITY, "===============================================================");
    }
