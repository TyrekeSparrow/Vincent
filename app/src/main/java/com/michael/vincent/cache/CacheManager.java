...
//
//import com.michael.vincent.display.DisplayTask;
//
...
//    }
//
//    public static byte[] getByteArray(String url, DisplayTask.OnProgressListener onProgressListener) {
//        int position = CacheManager.getCachePosition(url);
...
//    }
//
//    public static byte[] getByteArrayFromCache(String url, int position, DisplayTask.OnProgressListener onProgressListener) {
//        switch (position) {
//            case MEMORY:
